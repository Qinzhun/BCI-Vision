...
class Board(QFrame):
    ...
    # 训练参数
    def param(self):
        train = trainParams.trainParams(channel, timePoint, frequency, 95, groups)
            ...
            if not Data_queue.empty():
                ...
                if self.formsymbol != self.currentsymbol and self.currentsymbol == 6:
                    ...
                    if self.onlineStarted == 0:
                        self.readOnlineData = onlineClass.ReadData(channel, timePoint, frequency, 95)
